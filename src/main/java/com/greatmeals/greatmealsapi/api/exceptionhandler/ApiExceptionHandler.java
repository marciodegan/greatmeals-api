...
public class ApiExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    private ResponseEntity<Object> handleValidationInternal(Exception ex, HttpHeaders headers, HttpStatus status, WebRequest request, BindingResult bindingResult) {
        ...
        Problem problem = new Problem(status.value(), problemType.getTitle(), problemType.getUri(), detail, detail, problemObjects);
    ...
    protected ResponseEntity<Object> handleHttpMessageNotReadable(HttpMessageNotReadableException ex, HttpHeaders headers, HttpStatus status, WebRequest request) {
        ...
        if (rootCause instanceof InvalidFormatException) {
            return handlInvalidFormat((InvalidFormatException) rootCause, headers, status, request);
    ...
    private ResponseEntity<Object> handlePropertyBinding(
        ...
        // revisar userMessage mais específica para este caso
        Problem problem = createProblem(status, problemType, detail, detail);
    ...
    private ResponseEntity<Object> handlInvalidFormat(InvalidFormatException ex, HttpHeaders headers, HttpStatus status, WebRequest request) {
        ...
        Problem problem = createProblem(status, problemType, detail, MSG_ERRO_GENERICO_USUARIO_FINAL);
