...
insert into usuario (id, nome, email, senha, data_cadastro) values (1, 'Pedro', 'Pedro@email.com', 'p12345', utc_timestamp);
insert into usuario (id, nome, email, senha, data_cadastro) values (2, 'Joao', 'joao@email.com', 'p12345', utc_timestamp);
insert into usuario (id, nome, email, senha, data_cadastro) values (3, 'Maria', 'maria@email.com', 'p12345', utc_timestamp);
insert into usuario (id, nome, email, senha, data_cadastro) values (4, 'Marcio', 'rechgan@gmail.com', 'p12345', utc_timestamp);
insert into usuario (id, nome, email, senha, data_cadastro) values (5, 'Maria', 'marciodegan@yahoo.com', 'p12345', utc_timestamp);
